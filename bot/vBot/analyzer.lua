...
-- total de kills confirmados na sessão (só conta quando o "Loot of" chega,
-- ou seja, quando o player teve direito ao loot / deu mais dano no bicho)
Analyzer.getTotalKills = function()
  return totalKills
end
