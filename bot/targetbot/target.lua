...
ui.lowestHp.onClick = function()
  local on = ui.lowestHp:isOn()
  ui.lowestHp:setOn(not on)
  storage.TargetBotPrioritizeLowestHp = not on
end
ui.lowestHp:setOn(storage.TargetBotPrioritizeLowestHp == true)
